...
def get_hotspot_SSID():
    ssid = "Blue Iris Labs Border Router"
...
#debb: is this realy a generic ENTERPRISE config, need another?
#debb: how do we handle connecting to a captured portal?
